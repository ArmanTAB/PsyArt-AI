"""
АртМинд — Конфигурация и психологические маппинги v1.1
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Все константы, пороги, веса и маппинги вынесены из analyzer.py.
Позволяет менять параметры без изменения кода анализатора.

v1.1: Возрастные диапазоны (2,5) и (13,17) — согласовано с валидацией 2..17
"""
...
AGE_NORMS = {
    (2, 5):  {"label": "Дошкольники (2–5 лет)", "тревога": -15, "агрессия": -10, "спокойствие": 5, "fill_low_ok": True, "chaos_ok": True},
    (6, 8):  {"label": "Младший школьный возраст (6–8 лет)", "тревога": -5, "агрессия": -5},
    (9, 12): {"label": "Средний школьный возраст (9–12 лет)"},
    (13, 17):{"label": "Подростки (13–17 лет)", "агрессия": -12, "грусть": -10, "тревога": -8, "dark_ok": True},
}

AGE_STATE_THRESHOLDS = {
    (2, 5):   {"консультация": 4, "внимание": 2},
    (6, 8):   {"консультация": 3, "внимание": 1},
    (9, 12):  {"консультация": 3, "внимание": 1},
    (13, 17): {"консультация": 4, "внимание": 2},
}
