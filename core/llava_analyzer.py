...
{{
  "emotions": [
    ...
    {{"name": "страх",        "intensity": 0}},
    {{"name": "агрессия",     "intensity": 0}},
    {{"name": "спокойствие",  "intensity": 0}},
    {{"name": "одиночество",  "intensity": 0}},
    {{"name": "любовь",       "intensity": 0}},
    {{"name": "энергия",      "intensity": 0}}
  ],
  "colorAnalysis": {{
...
def _validate_and_fix(data: dict, age: Optional[int]) -> dict:
    ...
    all_names = ["радость","грусть","тревога","страх","агрессия",
                 "спокойствие","одиночество","любовь","энергия"]
